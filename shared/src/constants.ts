...
/** Jupiter Price API v3 (USD prices, batched). */
...
/** PnL sign thresholds (in %). */
export const PNL_POSITIVE_PCT = 0.1;
export const PNL_NEGATIVE_PCT = -0.1;

export const SOL_DECIMALS = 4;
